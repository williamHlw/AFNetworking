Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/williamHlw/AFNetworking'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me' }
  s.source   = { :git => 'https://github.com/williamHlw/AFNetworking', :tag => s.version }
  ...
  s.resource_bundles = {'AFNetworking' => ['privacy/PrivacyInfo.xcprivacy']}
